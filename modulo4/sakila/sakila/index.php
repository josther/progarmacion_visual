...
<body>
    ...
    <div class="col-lg-8 mx-auto p-3 py-md-5">
        ...
        <main>
            ...
            <div class="mb-5">
                <a href="/docs/5.1/examples/" class="btn btn-primary btn-lg px-4">Dowload magit the garderin</a>
            </div>
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <h2>Stracraft</h2>
                    <p>Starcraft es un juego de estrategia en tiempo real donde tu y otro jugador crean su base y ejercito en tiempo real</p>
                    <ul class="icon-list">
        ...
        <footer class="pt-5 my-5 text-muted border-top">
            Creado por Josue David Cruz Parra &middot; &copy; 2022
        </footer>
    </div>
